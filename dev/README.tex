...
bx-bases: python scripts (Interactive Command Modules -- ICM)
are used for bootstrapping the BISOS (ByStar Internet Services OS)
environment.

bx-pip and bx-bases are ICM scripts that will normally be installed in  /usr/local/bin. 
bx-bases then can create /bystar and that allows for bx-pip to thereafter to
