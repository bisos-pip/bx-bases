...
echo "This file (/bisos/git/bxRepos/bisos-pip/bx-bases/py3/bin/bx-isoSrBases.py) has been OBSOLETED"
...
""" #+begin_org
*  This file:/bisos/git/bxRepos/bisos-pip/bx-bases/py3/bin/bx-isoSrBases.py :: [[elisp:(org-cycle)][| ]]
